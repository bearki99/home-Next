...
const Article: React.FC = (props) => {
  ...
  useEffect(() => {
    ...
    const routeChange = async () => {
      ...
      const divList = articleRef.current?.getElementsByTagName('div') as HTMLCollection;
    ...
    const handleScroll = (e: any) => {
      ...
      for (; i < titleList.length - 1; i++) {
        if (e.path[1].pageYOffset >= titleList[i] && e.path[1].pageYOffset < titleList[i + 1]) {
          break;
        }
      }
      const itemList = catalogRef.current?.getElementsByClassName('item') as HTMLCollection;
    ...
    <div className={styles.view_container}>
      <div className={styles.main_container}>
        <div className={styles.article_panel}>
          ...
          <div>
            <Badge count={article.comment_count} color="#c2c8d1" offset={[0, 8]} >
              <div className={styles.panel_btn}>
                <svg className={styles.sprite_icon}>
          ...
          <div className={styles.article_area}>
            <article className={styles.article}>
              ...
              <div className={styles.author_info_wrapper}>
                <Image className={styles.author_img} src={article.author?.avatar} alt="" width="100" height="100" />
                <div className={styles.author_info_box}>
                  ...
                  <div className={styles.meta_box}>
                    ...
                    <span className={styles.view_count}> 阅读 {article.view_count}</span>
                  </div>
                </div>
              </div>
              <div className={styles.background_box}>
                <Image className={styles.article_background} src={article.image as string} alt="" width="400" height="400" />
              </div>
              <div style={{ whiteSpace: 'pre-line' }} className={styles.article_content} ref={articleRef} dangerouslySetInnerHTML={{ __html: renderContent.current }}>
              </div>
            </article>
          </div>
          <div className={styles.article_sidebar}>
            <div className={styles.author_block}>
              ...
              <div className={styles.info_box}>
                ...
                <span className={styles.description}>{article.author?.description}</span>
              </div>
            </div>
                  ...
                  return (
                    <>
                      <div className={styles.item}>
                        <div className={styles.entry_title}>{article.title}</div>
                        <div className={styles.entry_meta_box}>
                          <span className={styles.entry_meta}>{article.like_count}点赞</span>
                          <span className={styles.entry_meta}>&nbsp;·&nbsp;</span>
                          <span className={styles.entry_meta}>{article.comment_count}评论</span>
                        </div>
                      </div>
                    </>
                  )
