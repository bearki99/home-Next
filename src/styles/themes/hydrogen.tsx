...
export default function HydrogenTheme() {
  return (
    <style jsx global>
      {`
        @charset "UTF-8";
        ...
        .markdown-body h2::first-letter:not(code),
        .markdown-body h3::first-letter:not(code),
        .markdown-body p::first-letter:not(code) {
        ...
        .markdown-body a.footnote-backref::after,
        .markdown-body a.footnote-ref::after {
